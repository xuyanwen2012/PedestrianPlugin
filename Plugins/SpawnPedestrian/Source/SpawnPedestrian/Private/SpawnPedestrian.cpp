...
void FSpawnPedestrianModule::StartupModule()
{
	...
	
	{
		...
		MenuExtender->AddMenuExtension("WindowLayout", EExtensionHook::After, PluginCommands, FMenuExtensionDelegate::CreateRaw(this, &FSpawnPedestrianModule::AddMenuExtension));
	...
	
	{
		...
		ToolbarExtender->AddToolBarExtension("Settings", EExtensionHook::After, PluginCommands, FToolBarExtensionDelegate::CreateRaw(this, &FSpawnPedestrianModule::AddToolbarExtension));
...
void FSpawnPedestrianModule::PluginButtonClicked()
{
   FSpawnManager Manager{};
	...
	FText DialogText = FText::Format(
							...
							FText::FromString(TEXT("FSpawnPedestrianModule::PluginButtonClicked()")),
							FText::FromString(TEXT("SpawnPedestrian.cpp"))
					   );
